              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-12 text-right">
                    <a href="{{ route('course.create') }}" class="btn btn-sm btn-primary">{{ __('Add') }}</a>
                  </div>
                </div>
                        ...
                        <tr>
                          ...
                          <td class="td-actions text-right">
                              ...
                              <form action="{{ route('course.destroy', $course) }}" method="post">
                                  ...
                                  <a rel="tooltip" class="btn btn-success btn-link" href="{{ route('course.edit', $course) }}" data-original-title="" title="">
